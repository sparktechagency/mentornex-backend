...
router.post(
  ...
  validateRequest(ContentValidations.addContentZodSchema),
...
router.patch(
  '/:id',
  auth(USER_ROLES.MENTOR),
  validateRequest(ContentValidations.updateContentZodSchema),
...
router.get(
  ...
  ContentController.getContentForValidMentees
);
